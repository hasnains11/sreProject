...
ServerEndpoint::ServerEndpoint()
    : ExternalUnitServerEndpoint("/test"), connection_event_counter(0), disconnection_event_counter(0), received_message_counter(0) {
...
ExternalUnitTest::ExternalUnitTest()
    : ExternalUnitClientEndpoint("EchoTest"), echo_received(false) {}
